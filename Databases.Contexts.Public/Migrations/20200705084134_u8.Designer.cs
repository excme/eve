            ...
            modelBuilder.Entity("eveDirect.Databases.Contexts.Public.Models.EveOnlineAlliance", b =>
                {
                    ...
                    b.Property<DateTime?>("last_corps_list_update")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("last_info_updated")
                        .HasColumnType("timestamp without time zone");

                    b.Property<List<int>>("membersMigrations")
                        .HasColumnName("comigr")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("eveDirect.Databases.Contexts.Public.Models.EveOnlineCharacter", b =>
                {
                    ...
                    b.Property<bool>("have_corpMigrations")
                        .HasColumnType("boolean");

                    b.Property<ICollection<EveOnlineKillMail>>("killmails")
                        .HasColumnName("kma")
                        .HasColumnType("jsonb");

                    b.Property<DateTime?>("lastUpdate_corpHistory")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime>("last_update_affiliation")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime>("last_update_publicInfo")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("eveDirect.Databases.Contexts.Public.Models.EveOnlineCharacterCorpHistory", b =>
                {
                    ...
                    b.Property<bool>("have_migrations")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("eveDirect.Databases.Contexts.Public.Models.EveOnlineCorporation", b =>
                {
                    ...
                    b.Property<DateTime?>("lastUpdate_allianceHistory")
                        .HasColumnType("timestamp without time zone");
