...
namespace eveDirect.Shared.EsiConnector.Models
{
    ...
    /// </summary>
    public class CorporationTitlesResult:List<CorporationTitlesResult.CorporationTitlesItem>
    {
        public class CorporationTitlesItem
        {
            public int title_id { get; set; }
            public List<ERole> roles { get; set; }
            public List<ERole> grantable_roles { get; set; }
            public List<ERole> roles_at_hq { get; set; }
            public List<ERole> grantable_roles_at_hq { get; set; }
            public List<ERole> roles_at_base { get; set; }
            public List<ERole> grantable_roles_at_base { get; set; }
            public List<ERole> roles_at_other { get; set; }
            public List<ERole> grantable_roles_at_other { get; set; }
