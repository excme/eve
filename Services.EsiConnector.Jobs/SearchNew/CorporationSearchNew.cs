...
{
    /// <summary>
    /// Поиск новых корпораций
    /// </summary>
    public class CorporationSearchNew : ConnectorJob
    {
        public CorporationSearchNew(
            IReadWrite repoPublicCommon,
            ILogger<CorporationSearchNew> logger,
        ...
        public JobResult TaskSimple()
        {
            ...
            var result = search.TaskSimple(
                checkpointName: nameof(CorporationSearchNew)
            );
