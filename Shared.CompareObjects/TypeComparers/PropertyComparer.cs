namespace eveDirect.Shared.CompareObjects.TypeComparers
{
    ...
    /// <summary>
    /// Сравнение двух свойств (Note inherits from BaseComparer instead of TypeComparer
    /// </summary>
    public class PropertyComparer : BaseComparer
    {
        ...
        /// </summary>
        public bool PerformCompareProperties(CompareParms parms, bool ignoreBaseList = false)
        {
            bool areEqual = true;
        ...
        private void CompareProperty(CompareParms parms, PropertyEntity info, List<PropertyEntity> object2Properties)
        {
            ...
            if (!IsValidIndexer(parms.Config, info, parms.BreadCrumb))
            {
                ...
                objectValue2 = secondObjectInfo?.Value;
            }
            else
            {
        ...
        {
            var isHandleDynamicObject = HandleDynamicObject(parms.Config, objectValue, objectType);
            return isHandleDynamicObject
